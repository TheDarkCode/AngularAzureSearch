...
(function () {
    ...
    angular.module('homesCtrl').controller('homesRoute', ['$scope', '$location', '$sce', 'currentLocation', 'search', 'bestView', 'groupFilters', function ($scope, $location, $sce, currentLocation, search, bestView, groupFilters) {
