...
(function () {
    ...
    angular.module('homesCtrl').controller('homesMap',['$scope', '$location', 'searchBounds', 'formatFilter', 'drawPolygon', 'currentLocation', function ($scope, $location, searchBounds, formatFilter, drawPolygon, currentLocation) {
