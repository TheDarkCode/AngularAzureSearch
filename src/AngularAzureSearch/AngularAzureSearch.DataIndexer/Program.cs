...
namespace AngularAzureSearch.DataIndexer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _indexClient = _searchClient.Indexes.GetClient("trails-index");
        ...
        private static bool DeleteIndex()
        {
            ...
            try
            {
                _searchClient.Indexes.Delete("trails-index");
            }
            catch (Exception ex)
            {
        ...
        private static void CreateAndSyncIndexer()
        {
            ...
            try
            {
                var creds = new DataSourceCredentials("AccountEndpoint=[YOUR DOCUMENTDB CONNECTION STRING ENDING IN ';Database=YOURDBNAME']");
                DataSource ds = new DataSource("trails-datasource", DataSourceType.DocumentDb, creds, new DataContainer("Trails"));
                ds.Description = "Trails Dataset";

                Indexer idx = new Indexer();
                idx.Name = "trailsix";
                idx.Description = "Trails data indexer";
                idx.DataSourceName = "trails-datasource";
                idx.TargetIndexName = "trails-index";
                ...
                _searchClient.DataSources.Delete("trails-datasource");
                _searchClient.Indexers.Delete("trailsix");
                ...
                AzureOperationResponse response = _searchClient.Indexers.Run("trailsix");
                ...
                while (running)
                {
                    statusResponse = _searchClient.Indexers.GetStatus("trailsix");
