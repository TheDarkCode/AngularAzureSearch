...
namespace VSXtoMD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string md = app.ToMarkdown("C:/AngularAzureSearch/AngularAzureSearch.WebAPI/bin/AngularAzureSearch.WebAPI.XML");
            Console.WriteLine(md);
            System.IO.File.WriteAllText(@"C:/AngularAzureSearch/AngularAzureSearch.WebAPI/bin/AngularAzureSearch.WebAPI.md", md);
        }
